...
Una contradicción es una proposición lógica que siempre es falsa, sin importar los valores de verdad de sus componentes. Es una fórmula que es falsa en todas las interpretaciones posibles.
...
\begin{enumerate}[label=\alph*)]
	...
	\item Ley del \textit{silogismo hipotético}:
	...
	\begin{fmd-example}[Silogismo disyuntivo]
		\begin{itemize}
	...
	\item Ley de \textit{adición} o adición disyuntiva:
	\[ p \vdash p \lor q \]
	Notación clásica:
	\[
	\begin{array}{l}
	...
	\item Ley de \textit{adjunción} o adición conjuntiva:
	\[ p, q \ \vdash \ p \lor q \]
	Notación clásica:
	\[
	\begin{array}{l}
...
Las \textit{falacias formales} son errores de razonamiento que ocurren debido a una estructura lógica incorrecta en un argumento, independientemente de la verdad o falsedad de las proposiciones involucradas. Por lo tanto, el problema radica en la forma del argumento, no en su contenido.
\end{fmd-definition}
...
\begin{enumerate}[label=\roman*)]
	...
	\begin{fmd-example}[Negación del universal]
		\begin{itemize}
	...
	\begin{fmd-example}[Negación del existencial]
		\begin{itemize}
