...
La notación por extensión \index{conjunto!por extensión} lista cada elemento del conjunto de forma individual.
...
En la notación por comprensión \index{conjunto!por comprensión}, describimos las propiedades o características que deben cumplir los elementos del conjunto, luego, utilizamos una condición lógica para definir el conjunto.
...
\vspace{1em}
\index{conjunto!diferencia simétrica}
...
\index{relaciones!y particiones}
...
\vspace{3mm} \index{relaciones!de equivalencia}
...
\vspace{3mm} \index{clases de equivalencia}
...
\end{fmd-definition}
\begin{itemize}
	\item El conjunto de las imágenes (\gls{rango} o \textit{recorrido}) \index{rango} se identifica con el codominio de la función. No hay elementos del codominio que no sea la imagen de \textit{al menos un} elemento del dominio, en otras palabras, el rango y el codominio coinciden.
...
\index{composición de funciones} \index{funciones!composición de}
...
\vspace{3mm} \index{función!restricción de} \index{restricción de una función}
...
\begin{fmd-definition}[Extensión de una función] \index{extensión de una función} \index{función!extension de}
