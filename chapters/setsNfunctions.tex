...
\begin{itemize}
	...
	\item Propiedades del complemento del producto cartesiano \( (A \times B)^c \)
	\begin{enumerate}
		\item \( (A \times B)^c = \{ (x, y) \mid x \not \in A \text{ o } y \not \in B \} \)
		\item \( (A \times B)^c = (A^c \times B^c) \cup (A^c \times B) \cup (A \times B^c) \)
		\item \( (A \times B)^c \neq A^c \times B^c \)
