...
La \gls{notacionextension} \index{conjunto!por extensión} lista cada elemento del conjunto de forma individual.
...
\index{conjunto!por comprensión}
...
\vspace{1em}
\index{igualdad de conjuntos} \index{conjuntos!igualdad de}
\begin{fmd-definition}[\gls{igualdad_conjuntos}] \label{def:igualdad_conjuntos}
