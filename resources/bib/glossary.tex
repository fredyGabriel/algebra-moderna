...
\newglossaryentry{conjunto}{name=conjunto,
	description={Colección de objetos que comparten una característica común},
	text=conjunto,
	plural=conjuntos}
...
\newglossaryentry{pertenencia}{name=pertenencia (\ensuremath{\in}), symbol={\ensuremath{\in}},
	text=pertenencia, description={Indica que un elemento está o no en un conjunto.}}
...
\newglossaryentry{inclusion}{name=inclusión (\ensuremath{\subset}), symbol={\ensuremath{\subset}}, text=inclusión,
	description={Relación donde un conjunto (subconjunto) está completamente contenido en otro}}
...
\newglossaryentry{union}{name=unión (\ensuremath{\cup}), symbol={\ensuremath{\cup}},
	description={$A \cup B$ consiste en todos los elementos que pertenecen tanto a $A$, a $B$ o a ambos},
	text=unión,
	plural=uniones}
...
\newglossaryentry{interseccion}{name=intersección (\ensuremath{\cap}), symbol={\ensuremath{\cap}},
		description={$A \cap B$ contiene los elementos que pertenecen tanto a $A$ como a $B$},
		text=intersección,
...
text=diferencia simétrica, symbol={\ensuremath{\triangle}}, description={Conjunto que contiene los elementos que pertenecen al sustraendo y no al minuendo}}
...
\newglossaryentry{conjuntopotencia}{name=conjunto potencia (\ensuremath{\mathcal{P}(A)}),
	...
	description={Conjunto de todos los subconjuntos del conjunto \ensuremath{A}},
...
\newglossaryentry{clasequiv}{
	...
	description={Conjunto de elementos que tienen relación de equivalencia con $a$},
...
\newglossaryentry{contingencia}{name=contingencia,
		description={Proposición verdadera o falsa, dependiendo de las circunstancias},
		plural=contingencias}
	
\newglossaryentry{argumento}{name=argumento,
	description={Secuencia de premisas que pretende justificar una conclusión},
	plural=argumentos}
	
\newglossaryentry{razonamiento}{name={razonamiento deductivo válido},
	description={La verdad de las premisias garantiza la verdad de la conclusión},
	plural={razonamientos deductivos válidos}}
...
\newglossaryentry{cuantificadore}{name=cuantificador existencial (\ensuremath{\exists}),
	...
	description={Indica que existe al menos un elemento que cumple una propiedad dada},
...
\newglossaryentry{cuantificadoru}{name=cuantificador universal (\ensuremath{\forall}),
	...
	symbol={\ensuremath{\forall}}, description={Indica que todos los elementos cumplen una propiedad dada}}
