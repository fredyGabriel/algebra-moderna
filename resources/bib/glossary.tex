...
\newglossaryentry{disyuncione}{name=disyunción exclusiva (\ensuremath{\oplus}),
	text=disyunción exclusiva,
...
\newglossaryentry{reglasi}{name=reglas de inferencia,
	description={Patrones lógicos válidos que permiten deducir nuevas proposiciones a partir de premisas dadas.}}

\newglossaryentry{falacia}{name=falacia formal,
